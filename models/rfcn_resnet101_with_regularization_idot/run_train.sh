#!/usr/bin/env bash
ROOT_DIR=/home/nhat/google-object-detection-api-finetuning/models/rfcn_resnet101_with_regularization_idot
CONFIG_FILE=${ROOT_DIR}/rfcn_resnet101_with_regularization_idot.config
